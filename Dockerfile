...
COPY target/cise-sim-1.3.0.tar.gz /srv/cise-sim-1.3.0.tar.gz
RUN mkdir -p /srv/cise-simulator && tar xvfz /srv/cise-sim-1.3.0.tar.gz -C /srv/cise-simulator --strip-components 1
RUN rm /srv/cise-sim-1.3.0.tar.gz
