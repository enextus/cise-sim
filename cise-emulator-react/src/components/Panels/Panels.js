            ...
            <Paper style= {headerStyle}></Paper>
                ...
                <Grid item xs={8}>
                    <Paper style= {commandPaneStyle}>
                        <SendMessage store={this.props.store} messageCandidate={messageCandidate} messagePreview={messagePreview} />
                    </Paper>
                    ...
                    <Paper style= {ResultPaneStyle}>
                        ...
                        <ReceiveMessage store={this.props.store} messageCandidate={messageCandidate} messagePreview={messagePreview}/>
                    </Paper>
