...
import eu.cise.emulator.websocket.repentir.Message;
import eu.cise.emulator.websocket.repentir.MessageType;
...
public class OutBoundWebSocketService  {
    ...
    private void acknowledgeUserJoined(User user, Session session) throws JsonProcessingException {
        ...
        //message.setData(CiseEmuApplication.appLiveRunning.instanceID.getName()); cannot inform of inicial
