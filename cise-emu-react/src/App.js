...
import { DialogContentText, DialogContent, DialogTitle } from '@material-ui/core';
      ...
      <MuiThemeProvider>
        <div className="App">
          ...
          <Dialog
            ...
            <DialogTitle id="form-dialog-title">Connection point</DialogTitle>
            <DialogContent>
            <DialogContentText>
            Please enter the id address of the service to simulate here.
            Press enter to use the default value shown below
            :
          </DialogContentText>
            <TextField
              autoFocus
