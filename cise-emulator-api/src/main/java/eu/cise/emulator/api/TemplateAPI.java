...
public class TemplateAPI {
    ...
    public TemplateAPI(MessageProcessor messageProcessor, TemplateLoader templateLoader, XmlMapper xmlMapper) {
    ...
    public PreviewResponse preview(TemplateParams templateParams) {
        try {
            ...
            Template templateWithPreparedMessage = new Template(templateParams.getTemplateId(), template.getTemplateName(), xmlMapper.toXML(preparedMessage));
