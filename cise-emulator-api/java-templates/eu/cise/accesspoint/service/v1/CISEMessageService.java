...
@WebServiceClient(name = "CISEMessageService",
                  wsdlLocation = "file:/home/longama/IdeaProjects/cise-emu/cise-emulator-api/src/main/resources/META-INF/CISEMessageService.wsdl",
...
public class CISEMessageService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/longama/IdeaProjects/cise-emu/cise-emulator-api/src/main/resources/META-INF/CISEMessageService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CISEMessageService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/longama/IdeaProjects/cise-emu/cise-emulator-api/src/main/resources/META-INF/CISEMessageService.wsdl");
        }
        WSDL_LOCATION = url;
    }
