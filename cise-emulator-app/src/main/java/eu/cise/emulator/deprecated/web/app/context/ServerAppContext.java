package eu.cise.emulator.deprecated.web.app.context;


import eu.cise.emulator.deprecated.web.app.candidate.Sender;
import eu.cise.emulator.deprecated.web.app.util.SignatureDecorator;
import eu.cise.emulator.deprecated.web.app.util.SimLogger;
import eu.cise.emulator.deprecated.web.httptransport.Server;
import eu.cise.emulator.deprecated.web.httptransport.ServerRest;
import eu.cise.emulator.deprecated.web.httptransport.ServerRestConcrete;
import eu.cise.emulator.deprecated.web.integration.Validation.*;
...
public class ServerAppContext {
    ...
    public ServerAppContext() {
        ...
        DefaultSubmissionAgent asubmitagent = new DefaultSubmissionAgent(new eu.cise.emulator.deprecated.web.integration.Validation.MessageValidator(), submissionGatewayProcessor, config.getSimulatorId());
...
//        if (config.getWebappWsMode().contains("REST")) {
        ...
        ((eu.cise.emulator.deprecated.web.httptransport.ServerRestConcrete) myserver).setupServerRestConcrete(config.getSimulatorId(), acceptanceAgent);
        myserver = (ServerRest) myserver;

//        } else {
//            Server myserver = (ServerSoapConcrete) new ServerSoapConcrete();
//            ((eu.cise.emulator.deprecated.web.httptransport.ServerSoapConcrete) myserver).SetupServerSoapConcrete(config.getSimulatorId(), acceptanceAgent);
