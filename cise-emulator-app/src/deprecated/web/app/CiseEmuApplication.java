...
import eu.cise.emulator.deprecated.web.app.cli.CommandLineSender;
import eu.cise.emulator.deprecated.web.app.context.SimConfig;
import eu.cise.emulator.deprecated.web.app.core.InstanceID;
import eu.cise.emulator.deprecated.web.app.resource.InboundRESTMessageService;
import eu.cise.emulator.deprecated.web.app.resource.OutBoundRestServiceAPI;
import eu.cise.emulator.deprecated.web.app.transport.OutBoundWebSocketClient;
import eu.cise.emulator.deprecated.web.app.transport.OutBoundWebSocketService;
...
public class CiseEmuApplication extends Application<CiseEmuConfiguration> {
    ...
    public void run(final CiseEmuConfiguration configuration, final Environment environment) {
        ...
        final InboundRESTMessageService inboundRESTMessageService = new eu.cise.emulator.deprecated.web.app.resource.InboundRESTMessageService(this.instanceID, configuration, outRestMessageClient);
