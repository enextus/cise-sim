package eu.cise.emulator.deprecated.web.app.cli;

import eu.cise.emulator.deprecated.web.app.SimApp;
...
public class CommandLineSender extends Command {
    ...
    public void run(Bootstrap<?> bootstrap, Namespace namespace) throws Exception {
        ...
        SimConfig config;
        Logger logger = LoggerFactory.getLogger("eu.cise.emulator.deprecated.web.app.cli");
        ...
        SimLogger simLogger = new SimLogger.Slf4j();
